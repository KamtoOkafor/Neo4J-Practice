...
from neomodel import db, Q, clear_neo4j_database

def create_sample_data():
    # create skills
    python = Skill(name="Python").save()
...
def sample_describe_graph():
    rows, cols = db.cypher_query("MATCH (t:TeamMember)-[p:PROFICIENCY_FOR]-(s:Skill)" " RETURN t, p, s")
